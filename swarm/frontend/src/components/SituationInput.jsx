...
export default function SituationInput({ onLaunch, onBack, initialSituation = "", getIdToken }) {
  ...
  const handleLaunch = async () => {
    ...
    onLaunch(finalText, { timedMode, intent });
  };
        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 22 }}>
            ...
            <div>
              ...
              >
                Tell us about<br />your interview.
              </motion.h1>
              <motion.p
                initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2, duration: 0.5 }}
                style={{ fontFamily: "var(--ui)", fontWeight: 300, fontSize: 15, color: "var(--dim)", lineHeight: 1.7, maxWidth: 460 }}
              >
                Say it or type it: where, what for, how many interviewers.
                We'll build a fictional panel and a question plan you can see before you start.
              </motion.p>
            </div>
            ...
            >
              {canLaunch ? "Build my panel"
                ...
                : "Describe your interview to begin"}
            </motion.button>
