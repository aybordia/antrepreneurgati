    ...
    return (
      ...
      >
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--muted)", letterSpacing: "0.18em", marginBottom: "10px" }}>PHASE 4 OF 4</div>
            <div style={{ fontFamily: "var(--display)", fontSize: "38px", fontWeight: 400, marginBottom: "10px" }}>Ask Swarm AI</div>
            <div style={{ fontFamily: "var(--ui)", fontSize: "19px", color: "var(--muted)", lineHeight: 1.65 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", width: "100%" }}>
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: "var(--display)", fontSize: "21px", color: "var(--text)", marginBottom: "4px" }}>Voice</div>
                <div style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--muted)" }}>Speak your questions. Swarm AI talks back.</div>
              </div>
            </motion.button>
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: "var(--display)", fontSize: "21px", color: "var(--text)", marginBottom: "4px" }}>Text</div>
                <div style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--muted)" }}>Type your questions, read the answers</div>
              </div>
            </motion.button>
          </div>
        </div>
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--muted)", letterSpacing: "0.18em", marginBottom: "6px" }}>PHASE 4 OF 4</div>
          <div style={{ fontFamily: "var(--display)", fontSize: "32px", fontWeight: 400 }}>Ask Swarm AI</div>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "6px" }}>
            <span style={{
              fontFamily: "var(--mono)", fontSize: "15px", letterSpacing: "0.08em",
      ...
      <div style={{
        ...
        {messages.length === 0 && mode === "text" && (
          ...
          >
            <div style={{ fontFamily: "var(--mono)", fontSize: "15px", color: "rgba(139,138,155,0.45)", letterSpacing: "0.1em" }}>SUGGESTED</div>
              ...
              {SUGGESTIONS.map((s, i) => (
                <motion.button key={i}
                  ...
                  style={{
                    ...
                    fontFamily: "var(--mono)", fontSize: "16px", color: "var(--primary)",
          ...
          <AnimatePresence mode="wait">
            {isAISpeaking ? (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--primary)", letterSpacing: "0.06em" }}>
                  Swarm AI speaking…
                </span>
              </motion.div>
            ) : isStreaming ? (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--success)", letterSpacing: "0.06em" }}>
                  Thinking…
                </span>
              </motion.div>
            ) : isProcessing ? (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--mono)", fontSize: "16px", color: "var(--amber)", letterSpacing: "0.06em" }}>
                  Transcribing…
                </span>
              </motion.div>
            ) : (
              ...
              >
                ...
                <span style={{ fontFamily: "var(--mono)", fontSize: "16px", color: isListening ? "var(--amber)" : "var(--muted)", letterSpacing: "0.06em" }}>
          ...
          <form onSubmit={handleSubmit} style={{ position: "relative" }}>
            <input
              ...
              style={{
                ...
                fontSize: "19px", fontFamily: "var(--ui)", color: "var(--text)", outline: "none",
            ...
            <button type="submit" disabled={!input.trim() || isStreaming}
              style={{
                ...
                fontSize: "21px", transition: "all 0.18s",
