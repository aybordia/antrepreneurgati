      ...
      <div style={{
        ...
        <div style={{
          ...
          {MODES.map((m, i) => (
            ...
            >
              <span style={{ fontFamily: "var(--mono)", fontSize: 15, color: m.accent, letterSpacing: "0.14em" }}>
                {m.label}
              </span>
              <span style={{ fontFamily: "var(--display)", fontWeight: 500, fontSize: 25, color: "var(--text)" }}>
                {m.title}
              </span>
              <span style={{ fontFamily: "var(--ui)", fontWeight: 300, fontSize: 18, color: "var(--dim)", lineHeight: 1.65 }}>
                {m.body}
              </span>
              <span style={{
                marginTop: "auto", paddingTop: 8,
                fontFamily: "var(--mono)", fontSize: 16, color: m.accent, letterSpacing: "0.05em",
              }}>
                Choose →
              </span>
            </motion.button>
